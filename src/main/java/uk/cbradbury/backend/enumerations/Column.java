...
import uk.cbradbury.backend.enumerations.column_meta.AggregateType;
import uk.cbradbury.backend.enumerations.column_meta.SortType;
import uk.cbradbury.backend.enumerations.column_meta.Viewability;

import static uk.cbradbury.backend.enumerations.column_meta.AggregateType.*;
import static uk.cbradbury.backend.enumerations.column_meta.SortType.ASC;
import static uk.cbradbury.backend.enumerations.column_meta.SortType.DESC;
